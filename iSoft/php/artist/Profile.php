				...
				<div class="grid-uniform grid-link__container">
					<form name="myform" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
						...
						<table>
							...
							<tr>
								<td>
									DOB<input type="date" name="name"  placeholder="Date Of Birth">
								</td>
							</tr>
							<tr>
								<td>
									Expertise<input type="text" name="name"  placeholder="Expertise">
								</td>
							</tr>
							<tr>
								<td>
									Education<input type="text" name="name"  placeholder="Education">
								</td>
							</tr>
							<tr>
								<td>
									Work<input type="text" name="name"  placeholder="Work">
								</td>
							</tr>
							<tr>
