			...
			<div class="grid__item large--four-fifths">
				<div class="section-header section-header--large">
					...
					<div class="section-header__link--right medium-down--hide">
						...
						<a href="#" title="Browse our Gallery3 collection">Add Artist</a>
					</div>
				</div>
				<div class="grid-uniform grid-link__container">
					<form name="myform" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
						...
						<table>
							...
							<tr>
								<td>
									Statement<textarea name="state1" rows="4" cols="50"> </textarea>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>
									Area of expertise<br><input type="text" placeholder="">
								</td>
							</tr>
							<tr>
								<td>
									Degree/Education<br><input type="text" placeholder="">
								</td>
							</tr>
							<tr>
								<td>
				...
				<script>
					function validateForm() {
						...
						var d = document.forms["myform"]["lock"].value;
						var y = document.forms["myform"]["state1"].value;
