    ...
    <a href="#" class="">FAQ</a>
				...
				<div class="grid__item large--four-fifths">
					<div class="section-header section-header--large">
						<h2 class="section-header__title--left section-header__title h4">Announcement</h2>
						<div class="section-header__link--right medium-down--hide">
							<a href="Add-Announcement.php" title="Browse our Gallery3 collection">Add Announcement</a>
						</div>
					</div>
					<style>
					th, td {
