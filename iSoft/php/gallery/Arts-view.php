    ...
    <a href="#" class="">FAQ</a>
				...
				<div class="grid__item large--four-fifths">
					<div class="section-header section-header--large">
						...
						<a href="Gallery.php" title="Browse our Gallery3 collection">Dashboard</a>&nbsp;>
						<a href="Arts.php" title="Browse our Gallery3 collection">Arts</a>&nbsp;>
						<a href="#" title="Browse our Gallery3 collection">Arts Details</a>
					</div>
					</div>
					<style>
					th, td {
					...
					<div class="grid-uniform grid-link__container">
						...
						<div class="artv">
							<div class="cover">
								<img src="../images/logo.png" height="150" width="750">
							</div>
							<div class="leftv">
								<b>Title</b>
								<p>Artist arts</p>
								<b>Statement</b>
								<p style="text-align:justify;text-justify:inter-word;">stackoverflow.com/.../bootstrap-alignment-of-button-and-pagination
									Nov 4, 2013 - I am using Twitter Bootstrap 3 to build my new website. I want to place a button on ... The alternative is to simply extend the .pagination class</p>
								<b>Price</b>
								<p>Rs. 2000</p>
								<b>Location</b>
								<p>India</p>
