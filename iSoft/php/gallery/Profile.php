				...
				<div class="grid-uniform grid-link__container">
					<form name="myform" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
						...
						<table>
							...
							<tr>
								<td>
									About Us<textarea rows="4" cols="50"> </textarea>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>Cover Pic:<input type="file" name="imgfile"></td>
							</tr>
							<tr>
								<td>
									Location<select>
							...
							<tr>
								<td>
									Exhibition<input type="text" name="name"  placeholder="Exhibition">
								</td>
							</tr>
							<tr>
								<td>
									Contact Us<input type="text" name="name"  placeholder="Contact Us">
								</td>
							</tr>
