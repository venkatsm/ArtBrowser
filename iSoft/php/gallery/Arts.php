				...
				<div class="grid__item large--four-fifths">
					<div class="section-header section-header--large">
						...
						<div class="section-header__link--right medium-down--hide">
							<a href="Add-Arts.php" title="Browse our Gallery3 collection">Add Arts</a>
						</div>
					</div>
					<style>
					th, td {
					...
					<!----------------------------------------- start here content layout ------------------------------>
						...
						<div class="section-header section-header--large">
							<h2 class="section-header__title--left section-header__title h4"></h2>
							<div class="section-header__link--right medium-down--hide">
								<a href="Add-Arts.php" title="Browse our Gallery3 collection">View Arts Work</a>
							</div>
						</div>
						<div class="grid__item medium-down--one-half" style="width: 100%;margin-top:-20px;">
							<span class="grid-link__image grid-link__image--product">
							  <span class="grid-link__image-centered">
								<img src="../images/pic1.jpg" alt="Art 1" style="width:100%;height:100%;">
							  </span>
							</span>
							<div style="float:right;z-index:999">
								...
								<table>
									<tr>
										<td><a>Edit</a></td>
										<td><a href="Add-Arts.php"><img src="../images/ic_edit.png" style="height:30px;"/></a></td>										
									</tr>
								</table>
							</div>
							<p class="grid-link__meta" style="line-height:1;">
							  <a>Title:</a> Coral Reef
							</p>
							<p class="grid-link__meta" style="line-height:1;">
							  <a>Date:</a> 2013
							</p>
							<p class="grid-link__meta" style="line-height:1;">
							  <a>Medium:</a> Wood and Paint
							</p>
							<p class="grid-link__meta" style="line-height:1;">
							  <a>Size:</a> 51.4x67.3 in
							</p>
							<p class="grid-link__meta" style="line-height:1;">
							  <a>Price:</a> $580.00
							</p>
							<p style="line-height:1.2;text-align:justify;text-justify:inter-word;">
							  <a>Statement:</a>This piece represents the danger of coral reefs from global warming. I was influenced by the work of Pablo Picasso, and so used abstract shapes to create a piece with a strong and ecological meaning.
							</p>
							
							<p style="line-height:1.2;text-align:justify;text-justify:inter-word;">
								<a>Keywords:</a><br/>Coral, Reef, Picasso, Eco, Wood, Paint, Sculpture, Edinburgh
							</p>
						</div>
						<!----------------------------------------- end here content layout ------------------------------>
						<script>
							function deletefun(row_id){
								//alert(row_id);
								if (confirm("Are you sure you want to delete?")) {
									//document.getElementById("FORM_ID").submit();
									//window.location.href = 'delete_Brandlist.php?row_id='+row_id;
								}
								return false;
							}
						</script>
