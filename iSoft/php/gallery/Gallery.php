...
<body class="template-index">
  ...
  <ul id="MobileNav" class="mobile-nav large--hide">
		<li class="mobile-nav__link" aria-haspopup="true">
			<a href="Gallery.php" class="mobile-nav">Home</a>
		</li>
		<li class="mobile-nav__link" aria-haspopup="true">
			<a href="about.php" class="mobile-nav">About Us</a> 
		</li>
		<li class="mobile-nav__link" aria-haspopup="true">
			<a href="#" class="mobile-nav__sublist-trigger">Gallery
...
<ul class="site-nav" id="AccessibleNav">
      ...
      <li class="site-nav">
        <a href="./Gallery.php" class="site-nav__link">Home</a>
      </li>
  ...
  <li>
    <a href="Gallery-view.php" class="">Profile</a>
  </li>
...
<li>
 ...
 <div class="section-header section-header--large">
  <h2 class="section-header__title--left section-header__title h4">Arts</h2>
...
<div class="grid__item medium-down--one-half one-third text-center">
  ...
  <a href="#collections/desktop-pcs" title="Browse our Gallery1 collection" class="grid-link--focus">
    <span class="grid-link__image grid-link__image--collection" style="height: 205px;">
    ...
    <p class="grid-link__title">Gallery1</p>
...
<div class="grid__item medium-down--one-half one-third text-center">
  ...
  <a href="#collections/Gallery2" title="Browse our Gallery2 collection" class="grid-link--focus">
    <span class="grid-link__image grid-link__image--collection" style="height: 205px;">
      <span class="grid-link__image-centered">
        
          <img src="../images/Gallery1.jpg" alt="Gallery2">
        
      </span>
    </span>
    <p class="grid-link__title">Gallery2</p>
...
<div class="grid__item medium-down--one-half one-third text-center">
  ...
  <a href="#collections/Gallery3" title="Browse our Gallery3 collection" class="grid-link--focus">
    <span class="grid-link__image grid-link__image--collection" style="height: 205px;">
      <span class="grid-link__image-centered">
        
          <img src="../images/Gallery1.jpg" alt="Gallery3">
        
      </span>
    </span>
    <p class="grid-link__title">Gallery3</p>
...
<small class="view-more">
  <a href="#collections" title="Browse our Gallery3 collection">View all Collections</a>
</small>
...
<div class="grid__item medium-down--one-half large--one-quarter">
  <a href="#products/1tb-intenso-portable-external-hard-drive" class="grid-link">
    ...
    <p class="grid-link__title">Art 1</p>
    <p class="grid-link__meta">
      
      <strong>$45.99</strong>
      
      
        <br><span class="spr-badge" id="spr_badge_405352880" data-rating="5.0">
...
<div class="grid__item medium-down--one-half large--one-quarter">
  <a href="#products/acer-i3-8gb-750gb-win-8" class="grid-link">
    <span class="grid-link__image grid-link__image--product" style="height: 208px;">
      ...
      <span class="grid-link__image-centered">
        <img src="../images/Gallery1.jpg" alt="Acer E1 i3">
      </span>
    </span>
    <p class="grid-link__title">Art 2</p>
    <p class="grid-link__meta">
...
<div class="grid__item medium-down--one-half large--one-quarter">
  <a href="#products/acer-i7-6gb-750gb-win-8" class="grid-link">
    <span class="grid-link__image grid-link__image--product" style="height: 208px;">
      
      
      <span class="grid-link__image-centered">
        <img src="../images/Gallery1.jpg" alt="Acer E1-i5">
      </span>
    </span>
    <p class="grid-link__title">Art 3</p>
    <p class="grid-link__meta">
      
      <strong>$439.00</strong>
      
      
        <br><span class="spr-badge" id="spr_badge_405353076" data-rating="0.0">
